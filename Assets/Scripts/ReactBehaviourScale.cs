...
public class ReactBehaviourScale : AudioVisualizationEffect
{
    ...
    void Update()
    {
        ...
        if (_smoothFall)
        {
            ...
            var fallConstant = Mathf.Pow(0.05f * AudioScale, Power);
        ...
        var newScale = new Vector3(_originalScale.x + audioScale, _originalScale.y + audioScale, _originalScale.z + audioScale);
